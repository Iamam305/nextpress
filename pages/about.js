...
const about = () => {
  return (
    <>
    <h2 className='text-center container mx-auto pt-24 text-6xl font-light text-indigo-500'>ABOUT US</h2>
      ...
      <div className="flex flex-col sm:flex-row mt-10">
        <div className="sm:w-1/3 text-center sm:pr-8 sm:py-8">
          <div className="w-20 h-20 rounded-full inline-flex items-center justify-center bg-gray-200 text-gray-400">
            <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokWeidth="2" className="w-10 h-10" viewBox="0 0 24 24">
        ...
        <div className="sm:w-2/3 sm:pl-8 sm:py-8 sm:border-l border-gray-200 sm:border-t-0 border-t mt-4 pt-4 sm:mt-0 text-center sm:text-left">
          ...
          <a className="text-indigo-500 inline-flex items-center">Learn More
            <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokWeidth="2" className="w-4 h-4 ml-2" viewBox="0 0 24 24">
          ...
          <div className="flex-grow sm:pl-8">
            ...
            <span className="inline-flex">
              <a className="text-gray-500">
                <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokWeidth="2" className="w-5 h-5" viewBox="0 0 24 24">
